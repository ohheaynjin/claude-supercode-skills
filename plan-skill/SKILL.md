...
- **조기 식별**: 실행 단계가 아닌 계획 단계에서 위험을 식별합니다.
...
1. **컨텍스트 이해**: 전체 범위, 제약 조건 및 성공 기준을 파악합니다.
...
**완전성보다 명확성**: 완벽하지만 사용할 수 없는 계획보다 명확하고 실행 가능한 계획을 세우는 것이 더 좋습니다.
**점진적 정교화**: 단기 작업에 대한 세부 계획, 향후 작업에 대한 높은 수준
**위험 감소**: 불확실성을 최대한 빨리 줄이기 위한 구조 작업
...
- **종속성 관리**: [reference/dependent-mapping.md](reference/dependency-mapping.md)
